...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_QWEN35_TOKEN_EMBD_SCALED,               "token_embd" },
    { LLM_TENSOR_QWEN35_OUTPUT_SCALED,                   "output" },
    { LLM_TENSOR_QWEN35_ESCHA_ATTN_QKV,                  "blk.%d.attn_qkv" },
    { LLM_TENSOR_QWEN35_ESCHA_ATTN_GATE,                 "blk.%d.attn_gate" },
    { LLM_TENSOR_QWEN35_ESCHA_SSM_OUT,                   "blk.%d.ssm_out" },
    { LLM_TENSOR_QWEN35_ESCHA_ATTN_Q,                    "blk.%d.attn_q" },
    { LLM_TENSOR_QWEN35_ESCHA_ATTN_K,                    "blk.%d.attn_k" },
    { LLM_TENSOR_QWEN35_ESCHA_ATTN_V,                    "blk.%d.attn_v" },
    { LLM_TENSOR_QWEN35_ESCHA_ATTN_OUT,                  "blk.%d.attn_output" },
    { LLM_TENSOR_QWEN35_ESCHA_FFN_GATE,                  "blk.%d.ffn_gate" },
    { LLM_TENSOR_QWEN35_ESCHA_FFN_UP,                    "blk.%d.ffn_up" },
    { LLM_TENSOR_QWEN35_ESCHA_FFN_DOWN,                  "blk.%d.ffn_down" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_QWEN35_TOKEN_EMBD_SCALED,  {LLM_TENSOR_LAYER_INPUT,     GGML_OP_GET_ROWS_SCALED_I8}},
    {LLM_TENSOR_QWEN35_OUTPUT_SCALED,      {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT_SCALED_I8}},
    {LLM_TENSOR_QWEN35_ESCHA_ATTN_QKV,     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ESCHA_LINEAR}},
    {LLM_TENSOR_QWEN35_ESCHA_ATTN_GATE,    {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ESCHA_LINEAR}},
    {LLM_TENSOR_QWEN35_ESCHA_SSM_OUT,     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ESCHA_LINEAR}},
    {LLM_TENSOR_QWEN35_ESCHA_ATTN_Q,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ESCHA_LINEAR}},
    {LLM_TENSOR_QWEN35_ESCHA_ATTN_K,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ESCHA_LINEAR}},
    {LLM_TENSOR_QWEN35_ESCHA_ATTN_V,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ESCHA_LINEAR}},
    {LLM_TENSOR_QWEN35_ESCHA_ATTN_OUT,     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ESCHA_LINEAR}},
    {LLM_TENSOR_QWEN35_ESCHA_FFN_GATE,     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ESCHA_LINEAR}},
    {LLM_TENSOR_QWEN35_ESCHA_FFN_UP,       {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ESCHA_LINEAR}},
    {LLM_TENSOR_QWEN35_ESCHA_FFN_DOWN,     {LLM_TENSOR_LAYER_REPEATING, GGML_OP_ESCHA_LINEAR}},
    // dspark

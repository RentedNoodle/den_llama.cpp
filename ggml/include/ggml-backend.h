...
extern "C" {
    ...
    */
    ...
    GGML_API void                 ggml_backend_sched_set_expert_cache_mb(ggml_backend_sched_t sched, int mb);
    GGML_API void                 ggml_backend_sched_set_expert_prefetch(ggml_backend_sched_t sched, int lookahead);

...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_TURBO3_0  = 42, // TurboQuant 3-bit KV: 2-bit PolarQuant + 1-bit QJL
        GGML_TYPE_TURBO4_0  = 43, // TurboQuant 4-bit KV: 3-bit PolarQuant + 1-bit QJL
        GGML_TYPE_TURBO2_0  = 44, // TurboQuant 2-bit KV: 2-bit PolarQuant, no QJL
        GGML_TYPE_TURBO3_TCQ = 45, // TurboQuant 3-bit KV: Trellis-Coded Quantization
        GGML_TYPE_TURBO2_TCQ = 46, // TurboQuant 2-bit KV: TCQ (k=2, L=8, 256 states)
        GGML_TYPE_TURBO4_TCQ = 55, // TurboQuant 4-bit KV: TCQ (k=4, L=10, 1024 states)
        //
        //

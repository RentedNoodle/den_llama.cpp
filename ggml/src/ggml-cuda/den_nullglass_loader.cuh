...
#include <cstring>
#ifdef _WIN32
// Windows headers needed for POSIX compatibility shims
#include <windows.h>
#include <io.h>
#include <sys/stat.h>
#include <fcntl.h>

// POSIX compatibility layer for Windows — maps mmap/munmap to Win32 API
...
// POSIX file I/O compatibility for Windows
#define open      _open
#define close     _close
#define O_RDONLY  _O_RDONLY

// struct stat compatibility: nvcc C++ is strict about struct types,
// so we define stat as the concrete Windows type.

...
// NOTE: never called in production (only referenced in a comment).
// The placeholder body references undefined attention_kernel/ffn_kernel.
// Release DCE removes it; Debug keeps it -> link error. Guard for NDEBUG.
#if 0  // NDEBUG-guard: function never called, placeholder kernels undefined

...
extern "C" {
    ...
    // KVarN KV cache types (from BeeLlama/Anbeeld)
    // Tile-based variance-normalized quantization: 128x128 tiles,
    // Sinkhorn balancing, Walsh-Hadamard transform, per-row/col scales

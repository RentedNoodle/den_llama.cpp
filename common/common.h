...
struct common_params_speculative {
    common_speculative_type type = COMMON_SPECULATIVE_TYPE_NONE; // type of speculative decoding (default: NONE - CATS corrupts recurrent state)
...
struct gpt_params {
    ...
    bool only_active_exps  = false; // TEST: disabled to isolate double-free
    int32_t expert_cache_mb = 4096; // --expert-cache-mb N: VRAM (MiB) for hot-expert LRU cache (0 = off)
    int32_t cpu_moe_prefetch = 2;   // --cpu-moe-prefetch N: speculative expert-prefetch lookahead (0 = off)

...
struct common_params_sampling {
    ...
    float   penalty_repeat     = 1.10f;  // 1.0 = disabled; Den: default ON to break reasoning loops
    float   penalty_freq       = 0.00f;  // 0.0 = disabled
    float   penalty_present    = 0.00f;  // 0.0 = disabled
    float   dry_multiplier     = 0.8f;   // 0.0 = disabled;      DRY repetition penalty for tokens extending repetition: Den: default ON

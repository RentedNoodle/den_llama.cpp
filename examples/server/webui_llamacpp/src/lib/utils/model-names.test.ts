<<<<<<< Updated upstream:examples/server/webui_llamacpp/src/lib/utils/model-names.test.ts
...
>>>>>>> Stashed changes:examples/server/webui_llamacpp/tests/unit/model-names.test.ts

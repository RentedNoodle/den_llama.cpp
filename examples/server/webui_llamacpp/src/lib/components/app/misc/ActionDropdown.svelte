<<<<<<< Updated upstream:examples/server/webui_llamacpp/src/lib/components/app/misc/ActionDropdown.svelte
<script lang="ts">
...
{#snippet iconComponent(IconComponent: Component, className: string)}
	<IconComponent class={className} />
{/snippet}
>>>>>>> Stashed changes:examples/server/webui_llamacpp/src/lib/components/app/navigation/DropdownMenuActions.svelte

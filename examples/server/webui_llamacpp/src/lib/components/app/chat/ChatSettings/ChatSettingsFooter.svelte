<<<<<<< Updated upstream:examples/server/webui_llamacpp/src/lib/components/app/chat/ChatSettings/ChatSettingsFooter.svelte
<script lang="ts">
...
>>>>>>> Stashed changes:examples/server/webui_llamacpp/src/lib/components/app/settings/SettingsFooter.svelte

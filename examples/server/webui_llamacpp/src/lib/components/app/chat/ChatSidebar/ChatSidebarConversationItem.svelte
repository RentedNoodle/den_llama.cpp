<<<<<<< Updated upstream:examples/server/webui_llamacpp/src/lib/components/app/chat/ChatSidebar/ChatSidebarConversationItem.svelte
<script lang="ts">
...
>>>>>>> Stashed changes:examples/server/webui_llamacpp/src/lib/components/app/navigation/SidebarNavigation/SidebarNavigationConversationItem.svelte

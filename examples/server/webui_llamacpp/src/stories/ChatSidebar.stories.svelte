<<<<<<< Updated upstream:examples/server/webui_llamacpp/src/stories/ChatSidebar.stories.svelte
...
>>>>>>> Stashed changes:examples/server/webui_llamacpp/tests/stories/SidebarNavigation.stories.svelte
